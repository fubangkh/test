...
def entry_dialog():
    ...
    def submit_data(stay_open):
        # 此处执行 conn.update 写入逻辑
        st.balloons()
        st.success("🎉 数据录入成功！")
        time.sleep(0.8)
        if not stay_open:
